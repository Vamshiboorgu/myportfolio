  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 sm:p-6 md:p-12">
      ...
      <motion.div
        ...
        className="relative w-full max-w-5xl aspect-video bg-black/50 border border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col z-[1000]"
      >
        ...
        <div className="flex-1 relative flex items-center justify-center overflow-hidden pt-16 pb-12">
